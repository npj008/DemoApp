...
let serialNetworkingQueue = DispatchQueue(label: "trialtask.networking.requests.serial.queue")
let concurrentNetworkingQueue = DispatchQueue(label: "trialtask.networking.requests.concurrent.queue", qos: .background, attributes: .concurrent)
